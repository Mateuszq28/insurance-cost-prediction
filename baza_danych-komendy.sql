...
CREATE TABLE data_formatted (
    ...
    b_weight FLOAT,
    age INTEGER,
    is_woman BOOLEAN, --one_hot_encoding
    bmi FLOAT,
    children INTEGER,
    is_smoking BOOLEAN, --one_hot_encoding
    is_region_north BOOLEAN, --one_hot_encoding
    is_region_east BOOLEAN, --one_hot_encoding
...
INSERT INTO data_formatted (date_written, height, b_weight, age, is_woman, bmi,
    children, is_smoking, is_region_north, is_region_east,
    expenses_ground_true)
    VALUES (2022-01-16, 178, 66.5, 23, true, 20.93,
    0, true, false,
    true, null);

INSERT INTO data_classifier_input (age, is_woman, bmi,
    children, is_smoking, is_region_north, is_region_east,
    expenses_ground_true)
